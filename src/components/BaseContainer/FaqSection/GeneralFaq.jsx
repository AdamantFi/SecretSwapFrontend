  ...
  return (
      <div className="tabs">
        <div className="tab">
            ...
            <label className="tab-label" htmlFor='general-check1'>What is Secret Swap?</label>
      ...
      <div className="tab">
        ...
        <label className="tab-label" htmlFor='general-check8'>Why does my transaction cost X?</label>
        <div className="tab-content">
          Secret Network requires $SCRT as gas to execute each transaction. Depending on the market price of $SCRT transaction costs can increase or decrease.
        </div>
      </div>
