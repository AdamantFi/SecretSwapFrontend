  ...
  return (
    <div className="tabs">
        <div className="tab">
            ...
            <label className="tab-label" htmlFor='support-check1'>I accidentally transferred my tokens to a pair contract, is there anyway I can get them back?</label>
      ...
      <div className="tab">
        ...
        <label className="tab-label" htmlFor='support-check3'>Will Keplr support SEFI staking at launch?</label>
        <div className="tab-content">
